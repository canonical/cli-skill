...
| Mehdi Bendriss | OpenSearch Lead | OpenSearch deployment, indexing, performance, COS, production ops |
...
| Phase 2 — Entrypoints & Validation | 4, 5, 7, 10 | AI API, search prototype, pilot benchmarking, COS | Depends on Phase 1 |
| Phase 3 — Polish & Production | 6, 8, 9 | Final UI & Ulwazi integration, production deployment, suggestions | Depends on Phase 2 |
...
### Story 5: Human Search UI — Functional Prototype

**Owner**: Nicholas Bello  
**Priority**: P1  
**Phase**: 2

Build a functional search UI prototype that demonstrates the new search capabilities and validates the UX approach.

| # | Sub-task | Acceptance Criteria |
|---|----------|-------------------|
| 5.1 | Build functional search prototype | Working prototype demonstrating search results display, basic filtering; stakeholder-approved design |
| 5.2 | Implement ReadTheDocs fallback in UI | If search exceeds 2 seconds, UI gracefully falls back to ReadTheDocs search; user is not blocked |

---

### Story 6: Human Search UI — Final Design & Ulwazi Integration

**Owner**: Vladimir  
**Priority**: P1  
**Phase**: 2

Take the functional prototype to final design and integrate into the Ulwazi Sphinx theme, replacing the existing search on documentation.ubuntu.com.

| # | Sub-task | Acceptance Criteria |
|---|----------|-------------------|
| 6.1 | Search UI design | Design based on UX work and prototype feedback; consistent with Ulwazi theme visual language; stakeholder-approved |
| 6.2 | Integrate into Ulwazi Sphinx theme | Search UI embedded in documentation.ubuntu.com theme; works across all docs pages; replaces old search (opt-in) |
| 6.3 | Theme review & QA | All theme pages render correctly with new search; no regressions in existing theme functionality |
...
**Owner**: Nicholas Bello / Mehdi Bendriss
**Priority**: P2  
**Phase**: 2  
...
Story 3 ─┘   Story 5 (Prototype) ──► Story 6 (Ulwazi)
             Story 7 (Pilot)     ──► Story 9 (Suggestions)
...
| Date | Author | Change |
|------|--------|--------|
| 2026-05-14 | — | Initial project plan |
| 2026-05-20 | Hartmut | Manual Updates |